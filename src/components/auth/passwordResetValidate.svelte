...
<div class="flex flex-1 flex-col items-center lg:items-start">
	<h2 class="font-bold text-3xl mb-4">Validate Password Reset</h2>
	<p class="mb-4">
		A verification message has been sent to your inbox. Please enter the verification code below to
		proceed.
	</p>
	<form on:submit|preventDefault={handleSubmit}>
		...
		<AuthButton title="Verify" {callInProgress} />
